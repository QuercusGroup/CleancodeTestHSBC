...
public class BookControllerTest {
    ...
    public void saveBook_OK() throws Exception {
        //Given
        Book aBook = new Book(null, "BookTitle", "BookAuthor", Boolean.TRUE);
        //When
    ...
    @Test
    public void getBookByTitle_OK() throws Exception {
        //Given
        ...
        //When
        MvcResult result = mockMvc.perform(get("/book/?title=BookTitle")
          .contentType(MediaType.APPLICATION_JSON))
          .andExpect(status().isOk())
          .andReturn();
        ...
        assertTrue(result.getResponse().getContentAsString().contains(bookTitle));
    }
